...
export default function TherapistDashboard() {
  ...
  if (needsProfile) {
    return (
      <div className="flex flex-col min-h-full items-center justify-center p-8 text-white max-w-[1200px] mx-auto w-full">
  ...
  return (
    <div className="flex flex-col min-h-full p-4 md:p-8 text-white max-w-[1200px] mx-auto w-full">
      <div className="flex flex-col items-center justify-center flex-1 text-center bg-white/[0.02] border border-white/[0.05] rounded-[14px] p-8">
        <h1 className="text-2xl font-semibold text-white/90 mb-3">Welcome to your Dashboard, {user?.name?.split(" ")[0]}!</h1>
